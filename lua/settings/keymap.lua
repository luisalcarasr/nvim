...
vim.api.nvim_set_keymap(
    "n",
    "<leader>ft",
    ":Telescope todo-comments todo initial_mode=normal<CR>",
...
vim.api.nvim_set_keymap(
    "n",
    "<leader>ch",
    ":Telescope neoclip plus initial_mode=normal<cr>",
    { noremap = true, silent = true }
)
...
vim.api.nvim_set_keymap(
    "n",
    "gi",
    ":Telescope lsp_implementation initial_mode=normal<CR>",
    { noremap = false, silent = true }
)
...
vim.api.nvim_set_keymap(
    "n",
    "<Leader>bw",
    ':bw!<cr><cms>lua require"nvim-tree.toggle(false, false)<cr>',
    { noremap = true, silent = true }
)
...
vim.api.nvim_set_keymap(
    "n",
    "<leader>gh",
    ":Telescope git_commits initial_mode=normal<cr>",
    { noremap = true, silent = true }
)
vim.api.nvim_set_keymap(
    "n",
    "<leader>gf",
    ":Telescope git_bcommits initial_mode=normal<cr>",
    { noremap = true, silent = true }
)
vim.api.nvim_set_keymap(
    "n",
    "<leader>gb",
    ":Telescope git_branches initial_mode=normal<cr>",
    { noremap = true, silent = true }
)
...
vim.api.nvim_set_keymap(
    "n",
    "<Leader>dp",
    ':lua require("mongo-nvim.telescope.pickers").database_picker("auxoneDB", "firstName")<cr>',
    { noremap = true, silent = true }
)
